<template>
  <div>
    ...
    <div style="margin-bottom: 20px">
      <el-input style="width: 240px" placeholder="请输入图书名称" v-model="params.bookName" @keydown.enter.native="load"></el-input>
      <el-input style="width: 240px; margin-left: 5px" placeholder="请输入图书标准码" v-model="params.bookNo" @keydown.enter.native="load"></el-input>
      <el-input style="width: 240px; margin-left: 5px" placeholder="请输入用户名称" v-model="params.userName" @keydown.enter.native="load"></el-input>
      <el-button-group>
    ...
    <el-table :data="tableData" stripe row-key="id"  default-expand-all>
      ...
      <el-table-column prop="bookName" label="图书名称" fixed="left"></el-table-column>

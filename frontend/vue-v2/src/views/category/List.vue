<template>
  <div>
    ...
    <div style="margin-bottom: 20px">
      <el-input style="width: 240px" placeholder="请输入分类名称" v-model="params.name" @keydown.enter.native="load"></el-input>
      <el-button-group>
...
<!--          scope.row 就是当前行数据-->
    ...
    <el-dialog title="添加二级分类" :visible.sync="dialogFormVisible" width="30%" custom-class="dialogClass">

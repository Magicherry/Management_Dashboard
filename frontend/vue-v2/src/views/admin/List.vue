<template>
  <div>
    ...
    <div style="margin-bottom: 20px">
      <el-input style="width: 240px" placeholder="请输入用户名" v-model="params.username" @keydown.enter.native="load"></el-input>
      <el-input style="width: 240px; margin-left: 5px" placeholder="请输入联系方式" v-model="params.phone" @keydown.enter.native="load"></el-input>
      <el-input style="width: 240px; margin-left: 5px" placeholder="请输入邮箱" v-model="params.email" @keydown.enter.native="load"></el-input>
      <el-button-group>
...
<!--          scope.row 就是当前行数据-->
    ...
    <el-dialog title="修改密码" :visible.sync="dialogFormVisible" width="30%" custom-class="dialogClass">
      <el-form :model="form" label-width="100px" ref="formRef" :rules="rules"> <!--校验规则-->

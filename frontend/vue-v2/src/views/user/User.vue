<template>
  <div>
    ...
    <div style="margin-bottom: 20px">
      <el-input style="width: 240px" placeholder="请输入名称" v-model="params.name" @keydown.enter.native="load"></el-input>
...
<!--          scope.row 就是当前行数据-->
    ...
    <el-dialog title="充值" :visible.sync="dialogFormVisible" width="30%" custom-class="dialogClass" >
      <el-form :model="form" label-width="100px" ref="ruleForm" :rules="rules" style="width: 85%">
        ...
        <el-form-item label="积分" prop="score">
          <el-input v-model="form.score" placeholder="请输入大于等于10小于或等于500的整数" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
  ...
  data() {
    const checkNums = (rule, value, callback) => {
      ...
      if (value < 10 || value > 500) {
        callback(new Error('请输入大于等于10小于或等于500的整数'));
      }
      callback()
    };
    return {

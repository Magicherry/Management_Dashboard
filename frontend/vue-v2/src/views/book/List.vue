<template>
  <div>
    ...
    <div style="margin-bottom: 20px">
      <el-input style="width: 240px" placeholder="请输入图书名称" v-model="params.name" @keydown.enter.native="load"></el-input>
      <el-input style="width: 240px; margin-left: 5px" placeholder="请输入图书标准码" v-model="params.bookNo" @keydown.enter.native="load"></el-input>
      <el-button-group>
    ...
    <el-table :data="tableData" stripe row-key="id" default-expand-all >
      <el-table-column prop="id" label="编号" width="50" fixed="left"></el-table-column>
      <el-table-column prop="name" label="图书名称" fixed="left"></el-table-column>
...
.text-ellipsis {
  ...
  line-height: 1.5em;
  max-height: 3em; /* Change this value to adjust the number of visible lines */
}

.description-cell .el-tooltip {
  white-space: normal;

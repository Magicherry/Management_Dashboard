  ...
  <div style="width: 80%">
    ...
    <el-form :inline="true" :rules="rules" ref="ruleForm" :model="form" label-width="100px">
      ...
      <el-form-item label="图书描述" prop="description">
        <el-input style="width: 523px" type="textarea" v-model="form.description" placeholder="请输入描述" :rows="3" ></el-input>
      </el-form-item>
      ...
      <el-form-item label="上传封面" prop="cover">
        <!-- <el-input v-model="from.cover" placeholder="请输入图片网址"></el-input> -->
        <el-upload
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        cover: [
          { required: true, message: '请输入封面网址', trigger: 'blur'}
        ],
      }
    }
  },

...
import com.example.zyt.exception.ServiceException;
import com.example.zyt.mapper.AdminMapper;
import com.example.zyt.service.IAdminService;
import com.example.zyt.utils.TokenUtils;
...
public class AdminService implements IAdminService {
    ...
    private static final String PASS_SALT = "Magicherry";
    ...
    private static String securePass(String password) {
        return SecureUtil.md5(password + PASS_SALT);
    }

    public static void main(String[] args) {
        String password = "123456";
        String encryptedPassword = securePass(password);
